...
def student_list():
    ...
    try:
        parser = argparse.ArgumentParser(prog='製作收費單.py', description='輸入檔名(例如: 收費資料.xlsx)')
        parser.add_argument('--file', '-f', default='收費資料.xlsx', type=str, required=False, help='輸入檔名(例如: 收費資料.xlsx)')
